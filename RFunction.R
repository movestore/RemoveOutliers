...
{
  if (is.null(maxspeed)) logger.info("No maximum speed provided, only manually marked Outliers removed.") else logger.info(pasteo("Remove manually marked outliers and positions with maximum speed > ", maxspeed,"m/s"))
